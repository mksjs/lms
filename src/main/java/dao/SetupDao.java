...
public class SetupDao {
    ...
    public void setup() {
        ...
        if (users.size() == 0) {
            ...
            User bob = new User("manish@gmail.com", "secret", "MANISH KUMAR",true);
...
//            entityManager.persist(bobPost3);
            Book book3 = new Book(" Thomas H. Cormen, Charles E. Leiserson, Ronald Rivest, Clifford Stein","Introduction to Algorithms" );
            entityManager.persist(book3);

            // Create a new post
//            Book book2 = new Book(bob, "My second post", lipsum);
//            entityManager.persist(book2);
            Book book2 = new Book("Donald Knuth", "The Art of Computer Programming");
            entityManager.persist(book2);
            
            // Create a new post
//            Article bobPost1 = new Article(bob, post1Title, post1Content);
//            entityManager.persist(bobPost1);
            Book book1 = new Book("Charles Petzold", "Code: The Hidden Language of Computer Hardware and Software");
